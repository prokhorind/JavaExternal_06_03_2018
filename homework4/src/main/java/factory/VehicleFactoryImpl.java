...
public class VehicleFactoryImpl implements AbstractVehicleFactory{
    ...
    public Vehicle getVehicle(int n) {
        switch (n) {
            case 0: return new Airplane(30,30,50,50,20000,2004,400,200,100);
            case 1: return new Amphibian(10,10,20,20,3000,2001,180);
            case 2: return new BatmansCar(10,10,20,20,3000,2001,220);
            case 3: return new Car(10,10,20,20,3000,2001,160);
            case 4: return new Ship(10,10,20,20,20000,2014,40,205,"Port Royal");
            default:{
